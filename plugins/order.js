...
module.exports = {
  ...
  rules: {
    'order/order': [
      ...
      // Class selector
      { type: 'rule', selector: /\.a/ },
      { type: 'rule', selector: /\.b/ },
      { type: 'rule', selector: /\.c/ },
      { type: 'rule', selector: /\.d/ },
      { type: 'rule', selector: /\.e/ },
      { type: 'rule', selector: /\.f/ },
      { type: 'rule', selector: /\.g/ },
      { type: 'rule', selector: /\.h/ },
      { type: 'rule', selector: /\.i/ },
      { type: 'rule', selector: /\.j/ },
      { type: 'rule', selector: /\.k/ },
      { type: 'rule', selector: /\.l/ },
      { type: 'rule', selector: /\.m/ },
      { type: 'rule', selector: /\.n/ },
      { type: 'rule', selector: /\.o/ },
      { type: 'rule', selector: /\.p/ },
      { type: 'rule', selector: /\.q/ },
      { type: 'rule', selector: /\.r/ },
      { type: 'rule', selector: /\.s/ },
      { type: 'rule', selector: /\.t/ },
      { type: 'rule', selector: /\.u/ },
      { type: 'rule', selector: /\.v/ },
      { type: 'rule', selector: /\.w/ },
      { type: 'rule', selector: /\.x/ },
      { type: 'rule', selector: /\.w/ },
      { type: 'rule', selector: /\.z/ },
      { type: 'rule', selector: /\./ },
      ...
      { type: 'rule', selector: /__a/ },
      { type: 'rule', selector: /__b/ },
      { type: 'rule', selector: /__c/ },
      { type: 'rule', selector: /__d/ },
      { type: 'rule', selector: /__e/ },
      { type: 'rule', selector: /__f/ },
      { type: 'rule', selector: /__g/ },
      { type: 'rule', selector: /__h/ },
      { type: 'rule', selector: /__i/ },
      { type: 'rule', selector: /__j/ },
      { type: 'rule', selector: /__k/ },
      { type: 'rule', selector: /__l/ },
      { type: 'rule', selector: /__m/ },
      { type: 'rule', selector: /__n/ },
      { type: 'rule', selector: /__o/ },
      { type: 'rule', selector: /__p/ },
      { type: 'rule', selector: /__q/ },
      { type: 'rule', selector: /__r/ },
      { type: 'rule', selector: /__s/ },
      { type: 'rule', selector: /__t/ },
      { type: 'rule', selector: /__u/ },
      { type: 'rule', selector: /__v/ },
      { type: 'rule', selector: /__w/ },
      { type: 'rule', selector: /__x/ },
      { type: 'rule', selector: /__w/ },
      { type: 'rule', selector: /__z/ },
